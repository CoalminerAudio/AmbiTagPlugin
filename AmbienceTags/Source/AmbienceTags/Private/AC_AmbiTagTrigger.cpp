...
void UAC_AmbiTagTrigger::DebugEvent()
{
	...
	DrawDebugString(GetWorld(), SpawnPoint, *FString::Printf(TEXT("Active AmbiCollections from AC %s : %d"), *DebugName.ToString(), ActiveAmbiTagCollections.Num()), nullptr, FColor::White, ambiTagSubsystem->debugDuration);
}
