...
// Begin ScriptStruct FAmbiTagAudioEvent
static FStructRegistrationInfo Z_Registration_Info_UScriptStruct_AmbiTagAudioEvent;
class UScriptStruct* FAmbiTagAudioEvent::StaticStruct()
{
	if (!Z_Registration_Info_UScriptStruct_AmbiTagAudioEvent.OuterSingleton)
	{
		Z_Registration_Info_UScriptStruct_AmbiTagAudioEvent.OuterSingleton = GetStaticStruct(Z_Construct_UScriptStruct_FAmbiTagAudioEvent, (UObject*)Z_Construct_UPackage__Script_AmbienceTags(), TEXT("AmbiTagAudioEvent"));
	}
	return Z_Registration_Info_UScriptStruct_AmbiTagAudioEvent.OuterSingleton;
}
template<> AMBIENCETAGS_API UScriptStruct* StaticStruct<FAmbiTagAudioEvent>()
{
	return FAmbiTagAudioEvent::StaticStruct();
}
struct Z_Construct_UScriptStruct_FAmbiTagAudioEvent_Statics
{
#if WITH_METADATA
	static constexpr UECodeGen_Private::FMetaDataPairParam Struct_MetaDataParams[] = {
		{ "BlueprintType", "true" },
	...
	static void* NewStructOps()
	{
		return (UScriptStruct::ICppStructOps*)new UScriptStruct::TCppStructOps<FAmbiTagAudioEvent>();
	}
	static const UECodeGen_Private::FStructParams StructParams;
};
const UECodeGen_Private::FObjectPropertyParams Z_Construct_UScriptStruct_FAmbiTagAudioEvent_Statics::NewProp_StartEvent = { "StartEvent", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FAmbiTagAudioEvent, StartEvent), Z_Construct_UClass_UFMODEvent_NoRegister, METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_StartEvent_MetaData), NewProp_StartEvent_MetaData) };
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UScriptStruct_FAmbiTagAudioEvent_Statics::PropPointers[] = {
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UScriptStruct_FAmbiTagAudioEvent_Statics::NewProp_StartEvent,
};
static_assert(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAmbiTagAudioEvent_Statics::PropPointers) < 2048);
const UECodeGen_Private::FStructParams Z_Construct_UScriptStruct_FAmbiTagAudioEvent_Statics::StructParams = {
	(UObject* (*)())Z_Construct_UPackage__Script_AmbienceTags,
	nullptr,
	&NewStructOps,
	"AmbiTagAudioEvent",
	Z_Construct_UScriptStruct_FAmbiTagAudioEvent_Statics::PropPointers,
	UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAmbiTagAudioEvent_Statics::PropPointers),
	sizeof(FAmbiTagAudioEvent),
	alignof(FAmbiTagAudioEvent),
	RF_Public|RF_Transient|RF_MarkAsNative,
	EStructFlags(0x00000201),
	METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FAmbiTagAudioEvent_Statics::Struct_MetaDataParams), Z_Construct_UScriptStruct_FAmbiTagAudioEvent_Statics::Struct_MetaDataParams)
};
UScriptStruct* Z_Construct_UScriptStruct_FAmbiTagAudioEvent()
{
	if (!Z_Registration_Info_UScriptStruct_AmbiTagAudioEvent.InnerSingleton)
	{
		UECodeGen_Private::ConstructUScriptStruct(Z_Registration_Info_UScriptStruct_AmbiTagAudioEvent.InnerSingleton, Z_Construct_UScriptStruct_FAmbiTagAudioEvent_Statics::StructParams);
	}
	return Z_Registration_Info_UScriptStruct_AmbiTagAudioEvent.InnerSingleton;
}
// End ScriptStruct FAmbiTagAudioEvent
...
struct Z_CompiledInDeferFile_FID_UnrealProjects_AmbiTagShowcase_AmbiTagShowcaseBuildout_AmbiTagProject_Plugins_AmbienceTags_Source_AmbienceTags_Public_AmbienceTagsData_h_Statics
{
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		...
		{ FAmbiTagAudioEvent::StaticStruct, Z_Construct_UScriptStruct_FAmbiTagAudioEvent_Statics::NewStructOps, TEXT("AmbiTagAudioEvent"), &Z_Registration_Info_UScriptStruct_AmbiTagAudioEvent, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FAmbiTagAudioEvent), 1857380522U) },
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_AmbiTagShowcase_AmbiTagShowcaseBuildout_AmbiTagProject_Plugins_AmbienceTags_Source_AmbienceTags_Public_AmbienceTagsData_h_2636960135(TEXT("/Script/AmbienceTags"),
	nullptr, 0,
