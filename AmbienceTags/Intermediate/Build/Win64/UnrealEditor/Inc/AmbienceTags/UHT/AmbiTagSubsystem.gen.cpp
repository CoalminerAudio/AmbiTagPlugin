...
const UECodeGen_Private::FFloatPropertyParams Z_Construct_UClass_UAmbiTagSubsystem_Statics::NewProp_debugDuration = { "debugDuration", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UAmbiTagSubsystem, debugDuration), METADATA_PARAMS(UE_ARRAY_COUNT(NewProp_debugDuration_MetaData), NewProp_debugDuration_MetaData) };
...
const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_UAmbiTagSubsystem_Statics::PropPointers[] = {
	...
	(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_UAmbiTagSubsystem_Statics::NewProp_debugDuration,
...
struct Z_CompiledInDeferFile_FID_UnrealProjects_AmbiTagShowcase_AmbiTagShowcaseBuildout_AmbiTagProject_Plugins_AmbienceTags_Source_AmbienceTags_Public_AmbiTagSubsystem_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UAmbiTagSubsystem, UAmbiTagSubsystem::StaticClass, TEXT("UAmbiTagSubsystem"), &Z_Registration_Info_UClass_UAmbiTagSubsystem, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAmbiTagSubsystem), 640078139U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_AmbiTagShowcase_AmbiTagShowcaseBuildout_AmbiTagProject_Plugins_AmbienceTags_Source_AmbienceTags_Public_AmbiTagSubsystem_h_2809168007(TEXT("/Script/AmbienceTags"),
