...
struct Z_Construct_UClass_UAmbiTagSettings_Statics
{
	...
	static constexpr UECodeGen_Private::FMetaDataPairParam NewProp_DebugLength_MetaData[] = {
		{ "Category", "General" },
#if !UE_BUILD_SHIPPING
		{ "Comment", "//Length of time debug info will populate the screen for\n" },
#endif
		{ "ModuleRelativePath", "Public/AmbiTagSettings.h" },
#if !UE_BUILD_SHIPPING
		{ "ToolTip", "Length of time debug info will populate the screen for" },
#endif
	};
#endif // WITH_METADATA
...
struct Z_CompiledInDeferFile_FID_UnrealProjects_AmbiTagShowcase_AmbiTagShowcaseBuildout_AmbiTagProject_Plugins_AmbienceTags_Source_AmbienceTags_Public_AmbiTagSettings_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UAmbiTagSettings, UAmbiTagSettings::StaticClass, TEXT("UAmbiTagSettings"), &Z_Registration_Info_UClass_UAmbiTagSettings, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UAmbiTagSettings), 2664592227U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_AmbiTagShowcase_AmbiTagShowcaseBuildout_AmbiTagProject_Plugins_AmbienceTags_Source_AmbienceTags_Public_AmbiTagSettings_h_1332366572(TEXT("/Script/AmbienceTags"),
